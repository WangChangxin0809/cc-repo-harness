    ...
    return [
        ...
        ("SessionStart reports branch state",
         ...
         {"hook_event_name": "SessionStart", "source": "startup",
          "cwd": root}, True),
        ("PostToolUse surfaces a governing document",
         "shared/scripts/context/after_edit.py",
         {"hook_event_name": "PostToolUse", "tool_name": "Edit",
          "tool_input": {"file_path": os.path.join(
              root, "shared/scripts/context/after_edit.py")},
          "cwd": root}, True),
        ("PostToolUse stays quiet on a file nothing governs",
         "shared/scripts/context/after_edit.py",
         {"hook_event_name": "PostToolUse", "tool_name": "Edit",
