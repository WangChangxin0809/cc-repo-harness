...
class Service:
    ...
    def _tools(self):
        def room_join(name: str) -> dict[str, Any]:
        ...
        def room_claim(path: str, actor_token: str = '') -> dict[str, Any]:
        ...
        def room_release(path: str, lease: str, actor_token: str = '') -> dict[str, Any]:
            """Release your own current lease, never a stale lease or a peer's lease."""
            return self._actor(actor_token)[0].release(path, lease)
        def room_state(status: str = 'working', renew: bool = False, actor_token: str = '') -> dict[str, Any]:
        ...
        def room_broadcast(message: str, request_id: str, actor_token: str = '') -> dict[str, Any]:
        ...
        def room_read(after: int = 0, limit: int = 50, actor_token: str = '') -> dict[str, Any]:
        ...
        def room_open(path: str, create: bool = False, actor_token: str = '') -> dict[str, Any]:
        ...
        def room_apply(snapshot: str, text: str, request_id: str, actor_token: str = '') -> dict[str, Any]:
        ...
        def room_delete(snapshot: str, request_id: str, actor_token: str = '') -> dict[str, Any]:
        ...
        def room_rename(snapshot: str, destination: str, request_id: str, actor_token: str = '') -> dict[str, Any]:
...
def sdk_serve(service):
    ...
    for fn in service.tools.values():
        ...
        server.tool(structured_output=True)(functools.wraps(fn)(wrapper))
